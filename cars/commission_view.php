...
<form method="POST" class="card car-edit-card" data-confirm-submit="Save these commission car changes? Every changed field will be recorded in History.">
    ...
    <div class="card-body">
        ...
        <div class="form-actions form-actions-start"><button type="submit" class="btn btn-primary"><i class="ri-save-line"></i> Update</button><a href="commission_view.php?id=<?= clean($id) ?>" class="btn btn-outline">Cancel</a></div>
    </div>
</form>
<?php endif; ?>
