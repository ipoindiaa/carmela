    ...
    <div class="card">
        ...
        <div class="card-body" style="padding:0;">
            <table>
                ...
                <tr style="background:var(--bg-secondary);font-weight:700;"><td>Total Income</td><td class="text-right amount text-green"><?= formatAmount($pnl['total_income']) ?></td></tr>
            </table>
        </div>
    </div>
    <div class="card">
        ...
        <div class="card-body" style="padding:0;">
            <table>
                ...
                <tr style="background:var(--bg-secondary);font-weight:700;"><td>Total Expenses</td><td class="text-right amount text-red"><?= formatAmount($pnl['total_expenses']) ?></td></tr>
            </table>
        </div>
    </div>
</div>
