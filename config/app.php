...
define('ENTRY_TYPE_META', [
    ...
    'TOKEN_REFUND' => ['label' => 'Token Refund', 'flow' => 'out', 'category' => 'Cars', 'icon' => 'ri-refund-2-line', 'description' => 'Token money returned to a buyer. If the token was forfeited, this reduces that car\'s profit.', 'selectable' => false, 'summary' => true],
