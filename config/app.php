...
define('ENTRY_TYPE_META', [
    ...
    'RTO_RECOVERY' => ['label' => 'RTO Received', 'flow' => 'in', 'category' => 'Cars', 'icon' => 'ri-refund-2-line', 'description' => 'Record RTO money received from a buyer or party; link the car when known.', 'selectable' => true, 'summary' => true],
    ...
    'CAR_PURCHASE_PAYMENT' => ['label' => 'Car Purchase Payment', 'flow' => 'out', 'category' => 'Cars', 'icon' => 'ri-hand-coin-line', 'description' => 'Owner payment added to a car whose purchase amount is built from actual payments.', 'selectable' => false, 'summary' => true],
